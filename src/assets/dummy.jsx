...
export const securityFields = [
    { name: "current", placeholder: "Senha atual" },
    { name: "new", placeholder: "Nova senha" },
    { name: "confirm", placeholder: "Confirmar senha" },
];

// SIDEBAR 
export const menuItems = [
    { text: "Dashboard", path: "/", icon: <Home className="w-5 h-5" /> },
    { text: "Tarefas Pendentes", path: "/pending", icon: <ListChecks className="w-5 h-5" /> },
    { text: "Tarefas Concluidas", path: "/complete", icon: <CheckCircle2 className="w-5 h-5" /> },
]
