...
const Layout = ({onLogout, user}) => {
    ...
    <div className="p-2 sm:p-3 rounded-xl bg-white shadow-sm border border-purple-100 hover:shadow-md transition-all duration-300 hover:border-purple-100 group">
      <div className='flex items-center gap-2'>
        ...
        <div className='min-w-0'>
          <p className='text-lg font-bold sm:text-xl bg-gradient-to-br from-fuchsia-500 to-purple-600 bg-clip-text text-transparent'>{value}</p>
  ...
  if (error) return (
    <div className='min-h-screen bg-gray-50 flex items-center justify-center'>
      <div className='bg-red-600 p-4 rounded-xl border border-red-100 max-w-md'>
        <p className='font-medium mb-2'>Error laoding tarefas</p>
      ...
      <div className='ml-0 xl:ml-64 lg:ml-64 md:ml-16 pt-16 p-3 sm:p-4 md:p-4 transition-all duration-300'>
        <div className='grid grid-cols-1 gap-4 xl:grid-cols-3 sm:gap-6'>
          ...
          <div className='xl:col-span-1 space-y-4 sm:space-y-6'>
            <div className='bg-white rounded-xl shadow-sm p-4 sm:p-5 border border-purple-100'>
                ...
                <div className='relative pt-1'>
                  <div className='flex gap-1.5 items-center'>
                    <div className='flex-1 h-2 sm:h-3 bg-purple-100 rounded-full overflow-hidden'>
                      <div className='h-full bg-gradient-to-r from-fuchsia-500 to-purple-600 transition-all duration-500 bg-purple-500' style={{ width: `${status.completionPercentage}%` }}/>                
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className='space-y-2 sm:space-y-3'>
                ...
                {tasks.length === 0 && (
                  <div className='text-center py-4 sm:py-6 px-2'>
                    ...
                    <p className='text-xs text-gray-400 mt-1'>Tarefas irão aparecer aqui.</p>                    
                  </div>
                )}
              </div>
            </div>
