      ...
      <div className={SIDEBAR_CLASSES.desktop}>
        <div className='p-5 border-b border-purple-100 lg:block hidden'>
          <div className='flex items-center gap-3'>
            ...
            <div className=''>
              <h2 className='text-lg font-bold text-gray-800'>Olá, {userName}</h2>
              <p className='text-xs text-purple-500 font-medium flex items-center gap-1'>
                <Sparkles className='w-3 h-3'/> Hora de concluir tarefas!
              </p>
            </div>
          </div>
        </div>
        ...
        <div className='p-4 space-y-6 overflow-y-auto flex-1'>
          <div className={PRODUCTIVITY_CARD.container}>
            <div className={PRODUCTIVITY_CARD.header}>
              <h3 className={PRODUCTIVITY_CARD.label}>PRODUTIVIDADE</h3>
        ...
        <div className="fixed inset-0 z-40">
          <div className={SIDEBAR_CLASSES.mobileDrawerBackdrop} onClick={() => setMobileOpen(false)} />
            ...
            <div className='flex items-center gap-3 mb-6'>
              ...
              <div className=''>
                <h2 className='text-lg font-bold mt-16 text-gray-800'>Olá, {userName}</h2>
                <p className='text-xs text-purple-500 font-medium flex items-center gap-1'>
                  <Sparkles className='w-3 h-3'/> Hora de concluir tarefas!
                </p>
              </div>
